...
public sealed class EventManager : MonoBehaviour {
    ...
    [SerializeField] private Sprite Bartender;
    [SerializeField] private Sprite Coworker;
    [SerializeField] private Sprite Stranger1;
    [SerializeField] private Sprite Stranger2;
    [SerializeField] private Sprite Stranger3;
    [SerializeField] private Sprite Stranger4;
    [SerializeField] private Sprite Friend;
    [SerializeField] private Sprite TruckKun;
    [SerializeField] private Sprite PlagueDoctor;
    ...
    private Event[] MapRandomEvents;
    private Event[] HouseRandomEvents;
    private Event[] WorkRandomEvents;
    private Event[] ClubRandomEvents;
    private Event[] HospitalRandomEvents;
    ...
    public void RandomEvent() {
        ...
        var validEvents = randomEvents.Where(x => currentSanityPercent < x.PercentSanityRequired).ToList();
        ...
        var possibleEvents = validEvents.Where(x => Random.Range(1, 100) <= x.Chance).ToList();
